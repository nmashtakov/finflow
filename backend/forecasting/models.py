...
class MonthlyBudgetPlan(models.Model):
    ...
    goal_current_amount = models.DecimalField(max_digits=14, decimal_places=2, default=0)
    goal_months_left = models.PositiveSmallIntegerField(default=6)
    goal_required_monthly = models.DecimalField(max_digits=14, decimal_places=2, default=0)
    goal_balance_after_saving = models.DecimalField(max_digits=14, decimal_places=2, default=0)
